...
export default {
  ...
  computed: {
    ...
    ...mapGetters("contest", {
      filterContestByIdList: "filterContestByIdList",
      filterContestByKey: "filterContestByKey",
    }),
  },
  watch: {
    temp_search_data() {
  ...
  created() {
    ...
    if (this.$route.params.contest_list) {
      this.getMyContest(this.$route.params.contest_list);
    } else {
      this.Data = this.formatData(this.temp_data);
    }
  },
  ...
  methods: {
    search_all_data(val) {
      this.Data = this.formatData(this.filterContestByKey(this.temp_data, val));
    },
    getMyContest(contest_list) {
      this.Data = this.formatData(
        this.filterContestByIdList(this.temp_data, contest_list)
      );
    },
    formatData(val) {
      // console.log(val);
