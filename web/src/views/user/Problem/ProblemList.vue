...
export default {
  components: {
    ProblemList: defineAsyncComponent(() =>
      import("@/components/Problem/ProblemList.vue")
    ),
    ProblemNav: defineAsyncComponent(() =>
      import("@/components/Problem/ProblemNav.vue")
    ),
  },
  computed: {
    ...mapState({
    ...
    ...mapState("problem", {
      tag_list: (state) => state.problem_tag_list,
      course_list: (state) => state.problem_course_list,
      problem_list: (state) => state.problem_list,
    }),
    ...mapGetters("problem", {
      getProblemList: "filterProblemListWithStatus",
  ...
  watch: {
    ...
    problem_list() {
      this.temp_data = this.getProblemList(true);
