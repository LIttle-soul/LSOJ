<template>
  <div class="unfind-page">
    ...
    <nav>
      <div class="menu">
        <p class="website_name" @click="linkTo('/home')">LSOJ</p>
        <div class="menu_links">
          <router-link to="/about/About52AC" class="link">关于</router-link>
          <router-link to="/about/HelpCenter" class="link">帮助中心</router-link>
          <router-link to="/about/ContactUs" class="link">联系我们</router-link>
        </div>
        <div class="menu_icon">
          <span class="icon"></span>
        </div>
    ...
    <section class="wrapper">
      <div class="container">
        <div ref="scene" class="scene" data-hover-only="false">
        ...
        <div class="text">
          <article>
            <p>此页面正在开发中。。。</p>
            <button @click="linkTo('/home')">返回首页</button>
          </article>
        </div>
      </div>
    </section>
...
let scene = ref();
onMounted(() => {
  var parallax = new Parallax(unref(scene));
});
...
.unfind-page {
  ...
  .about {
    ...
    .logo {
      ...
      height: 40px;
      z-index: 9;
      background-image: url("@/assets/svg/logo_white.svg");
      background-size: 50%;
