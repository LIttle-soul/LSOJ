...
export default {
  data() {
    return {
      school_log: require("@/assets/icon/schoolLogo.jpg"),
      school_code: require("@/assets/icon/QRcode.png"),
      introduce: "在52AC，<br> 享受AC的快乐",
      src: "about",
      put_on_file:
...
@media screen and (max-width: 600px) {
  .web-footer .left-content {
    display: none;
  }
  .web-footer .right-content {
    width: 100%;
    text-align: center;
  }
}
