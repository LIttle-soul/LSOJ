export const user_nav = [
  ...
  { index: "/problemlist", name: "ProblemList", title: "问题" },
...
export const not_login = [
  { index: "/login", name: "Login", title: "登录" },
  { index: "/register", name: "Register", title: "注册" },
  { index: "/forgetpassword", name: "ForgetPassword", title: "忘记密码" },
];
...
export const admin_login = [
  { index: "/admin/userlist", name: "AdminUserList", title: "我的管理" },
];
