# Generated by Django 3.2.4 on 2021-07-03 07:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Password',
            fields=[
                ('user_id', models.CharField(max_length=32, primary_key=True, serialize=False, verbose_name='用户账号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_municipality', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.municipality', verbose_name='学校所在城市')),
            ],
            options={
                'db_table': 'school',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('defunct', models.BooleanField(default='0', verbose_name='是否屏蔽')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.school', verbose_name='团队所在学校')),
            ],
            options={
                'db_table': 'team',
                'managed': True,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.province', verbose_name='城市所在省份'),
        ),
        migrations.CreateModel(
            name='LoginLog',
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.password', verbose_name='用户账号')),
            ],
            options={
                'db_table': 'login_log',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('college_school', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.school', verbose_name='学院所在学校')),
            ],
            options={
                'db_table': 'college',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_college', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.college', verbose_name='班级所在学院')),
            ],
            options={
                'db_table': 'class',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_id', models.CharField(blank=True, max_length=50, null=True, verbose_name='用户学号')),
                ('user_name', models.CharField(blank=True, max_length=20, null=True, verbose_name='用户姓名')),
                ('user_nick', models.CharField(blank=True, max_length=24, null=True, verbose_name='用户昵称')),
                ('user_power', models.SmallIntegerField(choices=[(0, '超级管理员'), (1, '管理员'), (2, '教师'), (3, '志愿者'), (4, '用户')], default=4, verbose_name='用户身份')),
                ('user_score', models.IntegerField(default=0, verbose_name='用户得分')),
                ('user_sex', models.SmallIntegerField(choices=[(0, '男'), (1, '女')], verbose_name='用户性别')),
                ...
                ('user_address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.municipality', verbose_name='用户所在地址')),
                ('user_class', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.class', verbose_name='用户所在班级')),
                ('user_school', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.school', verbose_name='用户所在学校')),
                ('user_team', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.team', verbose_name='用户所在团队')),
            ],
            options={
                'db_table': 'user',
                'managed': True,
        ...
        migrations.AddField(
            model_name='team',
            name='trainer',
            field=models.ManyToManyField(blank=True, related_name='team_trainer', to='app.User', verbose_name='指导老师'),
        ),
        migrations.AddField(
            model_name='solution',
            name='user_id',
        ...
        migrations.AddField(
            model_name='problems',
            name='solved_user',
            field=models.ManyToManyField(blank=True, related_name='solved_user', to='app.User', verbose_name='以通过题目的用户'),
        ),
        migrations.CreateModel(
            name='News',
            fields=[
        ...
        migrations.AddField(
            model_name='class',
            name='class_teacher',
            field=models.ManyToManyField(blank=True, to='app.User', verbose_name='班级教师'),
        ),
    ]
